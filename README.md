...
6. Within `util/firbaseConfig.ts` replace the empty Firebase configuration with your Firebase configuration, which was assigned to your project when you created it and    can be found under your project settings on Firebase. It should resemble the following example:
    ...
    const firebaseConfig = {
      apiKey: "AIzaSyA0j1ntJWBBwGmmwD40mjrE_MtZvgyQHdQ",
      authDomain: "dazzlone-fa291.firebaseapp.com",
      projectId: "dazzlone-fa291",
      storageBucket: "dazzlone-fa291.appspot.com",
      messagingSenderId: "106791667803",
      appId: "1:106791667803:web:be83f8108ce840dcd6177e"
    };
    ```
...
console.log("ddddddd",darkMode)
  ...
  return (
    <button
      className="relative flex w-[50px] cursor-pointer items-center gap-2 rounded-xl  bg-[#bf6606] py-[2px] px-1 dark:bg-[#000000]"
